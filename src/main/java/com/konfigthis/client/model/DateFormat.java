 ...
 */
@ApiModel(description = "The date format setting for the budget.  In some cases the format will not be available and will be specified as null.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DateFormat {
  ...
  **/
   ...
   * @return the DateFormat instance itself
   */
  public DateFormat putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.format, dateFormat.format)&&
        Objects.equals(this.additionalProperties, dateFormat.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DateFormat>() {
           ...
           public DateFormat read(JsonReader in) throws IOException {
             ...
             DateFormat instance = thisAdapter.fromJsonTree(jsonObj);
