...
import com.konfigthis.client.model.TransactionsResponseData;
...
public class TransactionsResponse {
  ...
  **/
   ...
   * @return the TransactionsResponse instance itself
   */
  public TransactionsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, transactionsResponse.data)&&
        Objects.equals(this.additionalProperties, transactionsResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      TransactionsResponseData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TransactionsResponse>() {
           ...
           public TransactionsResponse read(JsonReader in) throws IOException {
             ...
             TransactionsResponse instance = thisAdapter.fromJsonTree(jsonObj);
