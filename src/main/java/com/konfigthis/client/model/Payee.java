...
public class Payee {
  ...
  **/
  ...
  @ApiModelProperty(value = "If a transfer payee, the `account_id` to which this payee transfers to")
  ...
  **/
   ...
   * @return the Payee instance itself
   */
  public Payee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, payee.id) &&
        ...
        Objects.equals(this.additionalProperties, payee.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, transferAccountId, deleted, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Payee>() {
           ...
           public Payee read(JsonReader in) throws IOException {
             ...
             Payee instance = thisAdapter.fromJsonTree(jsonObj);
