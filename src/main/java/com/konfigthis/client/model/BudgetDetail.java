...
public class BudgetDetail {
  ...
  **/
   ...
   * @return the BudgetDetail instance itself
   */
  public BudgetDetail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, budgetDetail.id) &&
        ...
        Objects.equals(this.additionalProperties, budgetDetail.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, lastModifiedOn, firstMonth, lastMonth, dateFormat, currencyFormat, accounts, payees, payeeLocations, categoryGroups, categories, months, transactions, subtransactions, scheduledTransactions, scheduledSubtransactions, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BudgetDetail>() {
           ...
           public BudgetDetail read(JsonReader in) throws IOException {
             ...
             BudgetDetail instance = thisAdapter.fromJsonTree(jsonObj);
