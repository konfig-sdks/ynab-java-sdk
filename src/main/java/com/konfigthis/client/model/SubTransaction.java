...
public class SubTransaction {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If a transfer, the account_id which the subtransaction transfers to")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If a transfer, the id of transaction on the other side of the transfer")
  ...
  **/
   ...
   * @return the SubTransaction instance itself
   */
  public SubTransaction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, subTransaction.id) &&
        ...
        Objects.equals(this.additionalProperties, subTransaction.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, transactionId, amount, memo, payeeId, payeeName, categoryId, categoryName, transferAccountId, transferTransactionId, deleted, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SubTransaction>() {
           ...
           public SubTransaction read(JsonReader in) throws IOException {
             ...
             SubTransaction instance = thisAdapter.fromJsonTree(jsonObj);
