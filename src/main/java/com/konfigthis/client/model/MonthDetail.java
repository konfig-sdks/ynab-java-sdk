...
public class MonthDetail {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The total amount of transactions categorized to 'Inflow: Ready to Assign' in the month")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The total amount budgeted in the month")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The total amount of transactions in the month, excluding those categorized to 'Inflow: Ready to Assign'")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The available amount for 'Ready to Assign'")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The Age of Money as of the month")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Whether or not the month has been deleted.  Deleted months will only be included in delta requests.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The budget month categories.  Amounts (budgeted, activity, balance, etc.) are specific to the {month} parameter specified.")
   ...
   * @return the MonthDetail instance itself
   */
  public MonthDetail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.month, monthDetail.month) &&
        ...
        Objects.equals(this.additionalProperties, monthDetail.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(month, note, income, budgeted, activity, toBeBudgeted, ageOfMoney, deleted, categories, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MonthDetail
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MonthDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MonthDetail>() {
           ...
           public MonthDetail read(JsonReader in) throws IOException {
             ...
             MonthDetail instance = thisAdapter.fromJsonTree(jsonObj);
