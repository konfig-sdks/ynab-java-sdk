...
public class CategoryGroupWithCategories {
  ...
  **/
   ...
   * @return the CategoryGroupWithCategories instance itself
   */
  public CategoryGroupWithCategories putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, categoryGroupWithCategories.id) &&
        ...
        Objects.equals(this.additionalProperties, categoryGroupWithCategories.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, hidden, deleted, categories, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CategoryGroupWithCategories>() {
           ...
           public CategoryGroupWithCategories read(JsonReader in) throws IOException {
             ...
             CategoryGroupWithCategories instance = thisAdapter.fromJsonTree(jsonObj);
