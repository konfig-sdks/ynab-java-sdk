...
public class MonthSummary {
  ...
  **/
   ...
   * @return the MonthSummary instance itself
   */
  public MonthSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.month, monthSummary.month) &&
        ...
        Objects.equals(this.additionalProperties, monthSummary.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(month, note, income, budgeted, activity, toBeBudgeted, ageOfMoney, deleted, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MonthSummary>() {
           ...
           public MonthSummary read(JsonReader in) throws IOException {
             ...
             MonthSummary instance = thisAdapter.fromJsonTree(jsonObj);
