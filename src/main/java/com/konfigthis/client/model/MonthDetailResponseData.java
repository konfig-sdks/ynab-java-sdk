...
public class MonthDetailResponseData {
  ...
  **/
   ...
   * @return the MonthDetailResponseData instance itself
   */
  public MonthDetailResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.month, monthDetailResponseData.month)&&
        Objects.equals(this.additionalProperties, monthDetailResponseData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(month, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MonthDetailResponseData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MonthDetailResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      MonthDetail.validateJsonObject(jsonObj.getAsJsonObject("month"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MonthDetailResponseData>() {
           ...
           public MonthDetailResponseData read(JsonReader in) throws IOException {
             ...
             MonthDetailResponseData instance = thisAdapter.fromJsonTree(jsonObj);
