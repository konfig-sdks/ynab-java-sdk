...
import com.konfigthis.client.model.SaveTransactionWithOptionalFields;
...
public class BulkTransactions {
  ...
  public BulkTransactions transactions(List<SaveTransactionWithOptionalFields> transactions) {
  ...
  **/
  ...
  public void setTransactions(List<SaveTransactionWithOptionalFields> transactions) {
   ...
   * @return the BulkTransactions instance itself
   */
  public BulkTransactions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactions, bulkTransactions.transactions)&&
        Objects.equals(this.additionalProperties, bulkTransactions.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (int i = 0; i < jsonArraytransactions.size(); i++) {
        SaveTransactionWithOptionalFields.validateJsonObject(jsonArraytransactions.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BulkTransactions>() {
           ...
           public BulkTransactions read(JsonReader in) throws IOException {
             ...
             BulkTransactions instance = thisAdapter.fromJsonTree(jsonObj);
