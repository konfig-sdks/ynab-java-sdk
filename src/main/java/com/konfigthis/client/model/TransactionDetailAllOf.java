...
public class TransactionDetailAllOf {
  ...
  public TransactionDetailAllOf() {
  }

  public TransactionDetailAllOf accountName(String accountName) {
  ...
  **/
  ...
  public TransactionDetailAllOf payeeName(String payeeName) {
  ...
  **/
  ...
  public TransactionDetailAllOf categoryName(String categoryName) {
  ...
  **/
  ...
  public TransactionDetailAllOf subtransactions(List<SubTransaction> subtransactions) {
  ...
  public TransactionDetailAllOf addSubtransactionsItem(SubTransaction subtransactionsItem) {
  ...
  **/
   ...
   * @return the TransactionDetailAllOf instance itself
   */
  public TransactionDetailAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TransactionDetailAllOf transactionDetailAllOf = (TransactionDetailAllOf) o;
    return Objects.equals(this.accountName, transactionDetailAllOf.accountName) &&
        Objects.equals(this.payeeName, transactionDetailAllOf.payeeName) &&
        Objects.equals(this.categoryName, transactionDetailAllOf.categoryName) &&
        Objects.equals(this.subtransactions, transactionDetailAllOf.subtransactions)&&
        Objects.equals(this.additionalProperties, transactionDetailAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionDetailAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionDetailAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionDetailAllOf is not found in the empty JSON string", TransactionDetailAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionDetailAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionDetailAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionDetailAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionDetailAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionDetailAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionDetailAllOf>() {
           @Override
           public void write(JsonWriter out, TransactionDetailAllOf value) throws IOException {
           ...
           @Override
           public TransactionDetailAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TransactionDetailAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TransactionDetailAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionDetailAllOf
  * @throws IOException if the JSON string is invalid with respect to TransactionDetailAllOf
  */
  public static TransactionDetailAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionDetailAllOf.class);
  }

 /**
  * Convert an instance of TransactionDetailAllOf to an JSON string
  *
  * @return JSON string
  */
