...
public class CategoryGroup {
  ...
  **/
   ...
   * @return the CategoryGroup instance itself
   */
  public CategoryGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, categoryGroup.id) &&
        ...
        Objects.equals(this.additionalProperties, categoryGroup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, hidden, deleted, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CategoryGroup>() {
           ...
           public CategoryGroup read(JsonReader in) throws IOException {
             ...
             CategoryGroup instance = thisAdapter.fromJsonTree(jsonObj);
