...
public class UserResponseData {
  ...
  **/
   ...
   * @return the UserResponseData instance itself
   */
  public UserResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.user, userResponseData.user)&&
        Objects.equals(this.additionalProperties, userResponseData.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserResponseData>() {
           ...
           public UserResponseData read(JsonReader in) throws IOException {
             ...
             UserResponseData instance = thisAdapter.fromJsonTree(jsonObj);
