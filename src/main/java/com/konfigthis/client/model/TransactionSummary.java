...
public class TransactionSummary {
  ...
  **/
  ...
  public TransactionSummary cleared(TransactionClearedStatus cleared) {
  ...
  **/
  ...
  public TransactionSummary flagColor(TransactionFlagColor flagColor) {
  ...
  **/
  ...
  public TransactionSummary flagName(String flagName) {
  ...
  **/
   ...
   * @return the TransactionSummary instance itself
   */
  public TransactionSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, transactionSummary.id) &&
        ...
        Objects.equals(this.flagName, transactionSummary.flagName) &&
        ...
        Objects.equals(this.additionalProperties, transactionSummary.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, date, amount, memo, cleared, approved, flagColor, flagName, accountId, payeeId, categoryId, transferAccountId, transferTransactionId, matchedTransactionId, importId, importPayeeName, importPayeeNameOriginal, debtTransactionType, deleted, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TransactionSummary>() {
           ...
           public TransactionSummary read(JsonReader in) throws IOException {
             ...
             TransactionSummary instance = thisAdapter.fromJsonTree(jsonObj);
