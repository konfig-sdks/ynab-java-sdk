...
import com.konfigthis.client.model.CategoryResponseData;
...
public class CategoryResponse {
  ...
  **/
   ...
   * @return the CategoryResponse instance itself
   */
  public CategoryResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, categoryResponse.data)&&
        Objects.equals(this.additionalProperties, categoryResponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CategoryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      CategoryResponseData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CategoryResponse>() {
           ...
           public CategoryResponse read(JsonReader in) throws IOException {
             ...
             CategoryResponse instance = thisAdapter.fromJsonTree(jsonObj);
