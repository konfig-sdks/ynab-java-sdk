...
public class TransactionsImportResponseData {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The list of transaction ids that were imported.")
   ...
   * @return the TransactionsImportResponseData instance itself
   */
  public TransactionsImportResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactionIds, transactionsImportResponseData.transactionIds)&&
        Objects.equals(this.additionalProperties, transactionsImportResponseData.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionsImportResponseData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionsImportResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TransactionsImportResponseData>() {
           ...
           public TransactionsImportResponseData read(JsonReader in) throws IOException {
             ...
             TransactionsImportResponseData instance = thisAdapter.fromJsonTree(jsonObj);
