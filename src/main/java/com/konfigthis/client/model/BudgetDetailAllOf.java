...
public class BudgetDetailAllOf {
  ...
  public BudgetDetailAllOf() {
  }

  public BudgetDetailAllOf accounts(List<Account> accounts) {
  ...
  public BudgetDetailAllOf addAccountsItem(Account accountsItem) {
  ...
  **/
  ...
  public BudgetDetailAllOf payees(List<Payee> payees) {
  ...
  public BudgetDetailAllOf addPayeesItem(Payee payeesItem) {
    if (this.payees == null) {
  ...
  **/
  ...
  public BudgetDetailAllOf payeeLocations(List<PayeeLocation> payeeLocations) {
  ...
  public BudgetDetailAllOf addPayeeLocationsItem(PayeeLocation payeeLocationsItem) {
  ...
  **/
  ...
  public BudgetDetailAllOf categoryGroups(List<CategoryGroup> categoryGroups) {
  ...
  public BudgetDetailAllOf addCategoryGroupsItem(CategoryGroup categoryGroupsItem) {
  ...
  **/
  ...
  public BudgetDetailAllOf categories(List<Category> categories) {
  ...
  public BudgetDetailAllOf addCategoriesItem(Category categoriesItem) {
  ...
  **/
  ...
  public BudgetDetailAllOf months(List<MonthDetail> months) {
  ...
  public BudgetDetailAllOf addMonthsItem(MonthDetail monthsItem) {
    if (this.months == null) {
  ...
  **/
  ...
  public BudgetDetailAllOf transactions(List<TransactionSummary> transactions) {
  ...
  public BudgetDetailAllOf addTransactionsItem(TransactionSummary transactionsItem) {
  ...
  **/
  ...
  public BudgetDetailAllOf subtransactions(List<SubTransaction> subtransactions) {
  ...
  public BudgetDetailAllOf addSubtransactionsItem(SubTransaction subtransactionsItem) {
  ...
  **/
  ...
  public BudgetDetailAllOf scheduledTransactions(List<ScheduledTransactionSummary> scheduledTransactions) {
  ...
  public BudgetDetailAllOf addScheduledTransactionsItem(ScheduledTransactionSummary scheduledTransactionsItem) {
  ...
  **/
  ...
  public BudgetDetailAllOf scheduledSubtransactions(List<ScheduledSubTransaction> scheduledSubtransactions) {
  ...
  public BudgetDetailAllOf addScheduledSubtransactionsItem(ScheduledSubTransaction scheduledSubtransactionsItem) {
  ...
  **/
   ...
   * @return the BudgetDetailAllOf instance itself
   */
  public BudgetDetailAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BudgetDetailAllOf budgetDetailAllOf = (BudgetDetailAllOf) o;
    return Objects.equals(this.accounts, budgetDetailAllOf.accounts) &&
        Objects.equals(this.payees, budgetDetailAllOf.payees) &&
        Objects.equals(this.payeeLocations, budgetDetailAllOf.payeeLocations) &&
        Objects.equals(this.categoryGroups, budgetDetailAllOf.categoryGroups) &&
        Objects.equals(this.categories, budgetDetailAllOf.categories) &&
        Objects.equals(this.months, budgetDetailAllOf.months) &&
        Objects.equals(this.transactions, budgetDetailAllOf.transactions) &&
        Objects.equals(this.subtransactions, budgetDetailAllOf.subtransactions) &&
        Objects.equals(this.scheduledTransactions, budgetDetailAllOf.scheduledTransactions) &&
        Objects.equals(this.scheduledSubtransactions, budgetDetailAllOf.scheduledSubtransactions)&&
        Objects.equals(this.additionalProperties, budgetDetailAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accounts, payees, payeeLocations, categoryGroups, categories, months, transactions, subtransactions, scheduledTransactions, scheduledSubtransactions, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BudgetDetailAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BudgetDetailAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BudgetDetailAllOf is not found in the empty JSON string", BudgetDetailAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BudgetDetailAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BudgetDetailAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BudgetDetailAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BudgetDetailAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<BudgetDetailAllOf>() {
           @Override
           public void write(JsonWriter out, BudgetDetailAllOf value) throws IOException {
           ...
           @Override
           public BudgetDetailAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BudgetDetailAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BudgetDetailAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BudgetDetailAllOf
  * @throws IOException if the JSON string is invalid with respect to BudgetDetailAllOf
  */
  public static BudgetDetailAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BudgetDetailAllOf.class);
  }

 /**
  * Convert an instance of BudgetDetailAllOf to an JSON string
  *
  * @return JSON string
  */
